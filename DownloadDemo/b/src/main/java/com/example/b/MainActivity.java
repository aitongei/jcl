    ...
    public class MainActivity extends AppCompatActivity implements DownloadProgressListener{
        ...
        private DownloadService.DownloadBinder mbind;
        private CustomProgressBar mProgress;
        private Intent downloadIntent;
        private ServiceConnection mServiceConnection = new ServiceConnection() {
            @Override
            public void onServiceConnected(ComponentName name, IBinder service) {
                mbind = (DownloadService.DownloadBinder) service;
                mbind.setListener(new DownloadProgressListener() {
                    @Override
